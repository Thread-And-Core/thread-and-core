...
export const metadata: Metadata = {
  ...
  description:
    "Every engagement represents production software: running systems, real constraints, real outcomes.",
};
      ...
      <section className="bg-ink-950">
        <div className="container-site pt-40 pb-20">
          ...
          <p className="mt-6 max-w-xl text-[1.0625rem] leading-relaxed text-fg-secondary">
            ...
            systems, real constraints, real outcomes.
          </p>
        </div>
      </section>
            ...
            {cases.map((c) => (
              <Reveal key={c.title}>
                <article className="rounded-[3px] border border-hairline bg-ink-800 p-8 transition-colors duration-500 hover:border-thread-500/50 md:p-10">
                  ...
                  <p className="mt-3 max-w-3xl leading-relaxed text-fg-secondary">
                    {c.body}
                  </p>
                  {c.stats && (
          ...
          <Reveal>
            <div className="mt-16 max-w-xl">
              <p className="leading-relaxed text-fg-secondary">
                Client names are withheld where confidentiality applies. Every
